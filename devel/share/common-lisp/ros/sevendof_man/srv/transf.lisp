...
(cl:in-package sevendof_man-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <transf-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'transf-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sevendof_man-srv:<transf-request> is deprecated: use sevendof_man-srv:transf-request instead.")))

(cl:ensure-generic-function 'frame_a-val :lambda-list '(m))
(cl:defmethod frame_a-val ((m <transf-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sevendof_man-srv:frame_a-val is deprecated.  Use sevendof_man-srv:frame_a instead.")
  (frame_a m))

(cl:ensure-generic-function 'frame_b-val :lambda-list '(m))
(cl:defmethod frame_b-val ((m <transf-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sevendof_man-srv:frame_b-val is deprecated.  Use sevendof_man-srv:frame_b instead.")
  (frame_b m))
...
(cl:defmethod cl:initialize-instance :after ((m <transf-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'transf-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sevendof_man-srv:<transf-response> is deprecated: use sevendof_man-srv:transf-response instead.")))

(cl:ensure-generic-function 'transf-val :lambda-list '(m))
(cl:defmethod transf-val ((m <transf-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sevendof_man-srv:transf-val is deprecated.  Use sevendof_man-srv:transf instead.")
  (transf m))
